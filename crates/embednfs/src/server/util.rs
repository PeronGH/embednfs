...
pub(super) fn res_status(res: &NfsResop4) -> NfsStat4 {
    match res {
        ...
        NfsResop4::SetClientId(status, _) => *status,
        NfsResop4::SetClientIdConfirm(status) => *status,
        NfsResop4::OpenConfirm(status, _) => *status,
        NfsResop4::Renew(status) => *status,
        NfsResop4::ReleaseLockowner(status) => *status,
